 ...
 * ================================================================
 * 模型优惠时钟 —— DeepSeek Harness 客户端 UI 插件
 *
...
.mc_pack-zone{margin-bottom:14px}
.mc_pack-zone:last-child{margin-bottom:0}
.mc_pack-zone-title{font-size:11.5px;font-weight:600;color:var(--dsw-alias-label-secondary,#4a4f57);margin:0 0 7px}
.mc_packs{display:grid;grid-template-columns:repeat(auto-fill,minmax(168px,1fr));gap:8px}
.mc_pack{border:1px solid var(--dsw-alias-border-l2,#e3e6ea);border-radius:8px;padding:9px 10px;display:flex;flex-direction:column;gap:5px}
.mc_pack-top{display:flex;justify-content:space-between;gap:6px;align-items:baseline}
.mc_pack-name{font-size:12px;font-weight:600;color:var(--dsw-alias-label-primary,#1a1a1a);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.mc_pack-spec{font-size:10.5px;color:var(--dsw-alias-label-tertiary,#8b929b);white-space:nowrap}
.mc_pack-price{display:flex;align-items:baseline;gap:6px}
.mc_pack-now{font-size:15px;font-weight:700;color:var(--dsw-alias-state-business-primary,#1f8a57);font-variant-numeric:tabular-nums}
.mc_pack-orig{font-size:10.5px;color:var(--dsw-alias-label-tertiary,#8b929b);text-decoration:line-through;font-variant-numeric:tabular-nums}
.mc_pack-off{margin-left:auto;font-size:10.5px;font-weight:600;color:var(--dsw-alias-state-business-primary,#1f8a57)}
.mc_pack-meta{font-size:10.5px;color:var(--dsw-alias-label-tertiary,#8b929b)}
.mc_pack-note{margin-top:10px;font-size:10.5px;line-height:1.6;color:var(--dsw-alias-label-tertiary,#8b929b)}
...
`;
		...
		const zh = {
			...
			"meta": "数据溯源",
			"pack": "资源包特惠",
			"pack.hint": "一次性买断的资源包 —— 与「几点用」无关，看的是「买同样的量省多少」。按官方专区分组而不按折率排序：各专区门槛不同（企业需认证、教育需师生身份），按折率混排会让高门槛商品排在最前。",
			"pack.off": "{d} 折",
			"pack.limit": "限购 {n} 次",
			"pack.valid": "有效期 {n} 个月",
			"pack.none": "暂无资源包数据",
			"pack.note": "资源包为一次性买断，额度有有效期、过期作废；多数商品有每人限购次数。价格取自官方活动页，可能随时调整，下单前请以官方页面为准。",
			"meta.verified": "已核实",
			"meta.reported": "待官方核实",
			"meta.stale": "待复核",
		...
		const en = {
			...
			"pack": "Resource packs",
			"pack.hint": "One-off prepaid packs — unrelated to time of day; the point is paying less for the same quota. Grouped by the vendor's own zones rather than by discount rate, because zone eligibility differs (enterprise needs verification, education needs student status) and mixing them by rate would put gated offers first.",
			"pack.off": "{d} off",
			"pack.limit": "Limit {n} per user",
			"pack.valid": "Valid {n} months",
			"pack.none": "No pack data",
			"pack.note": "Packs are one-off purchases; quota expires. Most have a per-user purchase limit. Prices come from the vendor's campaign page and may change — check the official page before buying.",
		...
		const DISCOUNTS = [
			...
			{ id: "ds-weekend", providerId: "deepseek", kind: "recurring",
			  ...
			  scope: "pay_as_you_go",
			  note: "DeepSeek 官方定价页脚注 2 原文：「其余时段，包括周末及中国法定节假日全天均为空闲时段」。此前仅见媒体口径，2026-09-22 已由官方页确认。",
			  src: "https://api-docs.deepseek.com/zh-cn/quick_start/pricing/",
			  conf: "verified", verifiedAt: "2026-09-22" },
			...
			{ id: "ali-night", providerId: "aliyun-bailian", kind: "recurring",
			  ...
			  note: "阿里云官方文档原文：「限时夜间五折：每晚 22:00 - 次日 08:00 调用 qwen3.8-max、deepseek-v4-pro-0813 等模型」。",
			  conf: "verified", verifiedAt: "2026-09-22" },
			...
			{ id: "tx-sep", providerId: "tencent-cloud", kind: "campaign",
			  ...
			  note: "腾讯云官方文档「优惠活动 1」：活动时间 2026年9月1日 00:00 - 9月30日 23:59（北京时间），下列模型积分价享刊例价 5 折。",
			  conf: "verified", verifiedAt: "2026-09-22" },
			{ id: "tx-k3-credits", providerId: "tencent-cloud", kind: "campaign",
			  ...
			  note: "腾讯云官方文档「优惠活动 2」：2026年9月4日 - 9月30日 23:59（北京时间），通用 Token Plan 积分价享刊例价 95 折，对应 Kimi K3。",
			  conf: "verified", verifiedAt: "2026-09-22" },
			...
			{ id: "zp-flash-half", providerId: "zhipu", kind: "campaign",
			  ...
			  conf: "reported", status: "expired", verifiedAt: null,
			  note: "【2026-09-22 复核更正】本条描述的实为智谱「GLM Coding Plan 夜间畅用活动」，官方 notice 页原文：9 月 3 日至 9 月 20 日，每晚 23:00 至次日 09:00，调用套餐中的 GLM-5.3-Flash 在 ZCode 中免费、在其他支持的 Agent 中额度翻倍（相当于半价），覆盖所有付费套餐用户。⇒ 三处修正：① 它是 Coding Plan 套餐权益（subscription）而非按量计费；② 官方措辞是「额度翻倍」而非「五折」；③ 活动已于 2026-09-20 结束。本插件另有 zp-night-free 一条已完整记录该活动（含起止日与官方链接），本条降级为 expired 以避免重复与误导。" },
			...
			{ id: "mm-permanent", providerId: "minimax", kind: "structural",
			  ...
			  conf: "verified", verifiedAt: "2026-09-22",
			  note: "MiniMax 官方定价（markdown 端点）标注「永久五折」，价格列 ~~4.20~~ 2.10，折率恰为 0.50。"
			}
		];

		/* ---------- 资源包特惠（智谱官方 special_area 页，2026-09-22 实抓）----------
		 *
		 * 与 DISCOUNTS 的区别：这里是一次性买断的**资源包**，没有时间维度 ——
		 * 卖点是「买同样的量花更少的钱」，而非「某个时段更便宜」。
		 * 故作独立数组、独立区块，不进热力带。
		 *
		 * ⚠️ 不要手工编辑：数据由抓取脚本生成，手工改会在下次再生时被覆盖。
		 */
		const RESOURCE_PACKS = [
			{ id: "zp-flash_sale-glm53", zone: "flash_sale",
			  name: "GLM-5.3", spec: "2000万tokens",
			  now: 39.9, orig: 80, limit: 1, valid: 3 },
			{ id: "zp-flash_sale-glm53尊享包", zone: "flash_sale",
			  name: "GLM-5.3尊享包", spec: "1亿tokens",
			  now: 199.9, orig: 400, limit: 1, valid: 3 },
			{ id: "zp-flash_sale-联网搜索工具", zone: "flash_sale",
			  name: "联网搜索工具", spec: "2千次",
			  now: 39.9, orig: 100, limit: 1, valid: 3 },
			{ id: "zp-flash_sale-glmocr", zone: "flash_sale",
			  name: "GLM-OCR", spec: "5000万tokens",
			  now: 2.9, orig: 10, limit: 1, valid: 3 },
			{ id: "zp-flash_sale-glmimage", zone: "flash_sale",
			  name: "GLM-Image", spec: "200次",
			  now: 5.9, orig: 20, limit: 1, valid: 3 },
			{ id: "zp-flash_sale-cogvideox3", zone: "flash_sale",
			  name: "CogVideoX-3", spec: "100次",
			  now: 29.9, orig: 100, limit: 1, valid: 3 },
			{ id: "zp-developer-glm53", zone: "developer",
			  name: "GLM-5.3", spec: "2000万tokens",
			  now: 72, orig: 80, limit: 3, valid: 3 },
			{ id: "zp-developer-glm53flash", zone: "developer",
			  name: "GLM-5.3-Flash", spec: "5000万tokens",
			  now: 18, orig: 20, limit: 3, valid: 3 },
			{ id: "zp-developer-联网搜索工具", zone: "developer",
			  name: "联网搜索工具", spec: "2千次",
			  now: 70, orig: 100, limit: 3, valid: 3 },
			{ id: "zp-developer-glmocr", zone: "developer",
			  name: "GLM-OCR", spec: "5000万tokens",
			  now: 8, orig: 10, limit: 3, valid: 3 },
			{ id: "zp-developer-glmimage", zone: "developer",
			  name: "GLM-Image", spec: "500次",
			  now: 40, orig: 50, limit: 3, valid: 3 },
			{ id: "zp-developer-cogvideox3", zone: "developer",
			  name: "CogVideoX-3", spec: "200次",
			  now: 140, orig: 200, limit: 3, valid: 3 },
			{ id: "zp-enterprise-glm53", zone: "enterprise",
			  name: "GLM-5.3", spec: "10亿tokens",
			  now: 3600, orig: 4000, limit: 3, valid: 3 },
			{ id: "zp-enterprise-glm53flash", zone: "enterprise",
			  name: "GLM-5.3-Flash", spec: "10亿tokens",
			  now: 360, orig: 400, limit: 3, valid: 3 },
			{ id: "zp-enterprise-联网搜索工具", zone: "enterprise",
			  name: "联网搜索工具", spec: "10万次",
			  now: 3500, orig: 5000, limit: 3, valid: 4 },
			{ id: "zp-enterprise-glmocr", zone: "enterprise",
			  name: "GLM-OCR", spec: "100亿tokens",
			  now: 1600, orig: 2000, limit: 3, valid: 4 },
			{ id: "zp-enterprise-glmimage", zone: "enterprise",
			  name: "GLM-Image", spec: "1万次",
			  now: 800, orig: 10000, limit: 3, valid: 4 },
			{ id: "zp-enterprise-cogvideox3", zone: "enterprise",
			  name: "CogVideoX-3", spec: "1万次",
			  now: 7000, orig: 10000, limit: 3, valid: 4 },
			{ id: "zp-education-glm53", zone: "education",
			  name: "GLM-5.3", spec: "2000万tokens",
			  now: 72, orig: 80, limit: 3, valid: 3 },
			{ id: "zp-education-glm53flash", zone: "education",
			  name: "GLM-5.3-Flash", spec: "5000万tokens",
			  now: 18, orig: 20, limit: 3, valid: 3 },
			{ id: "zp-education-联网搜索工具", zone: "education",
			  name: "联网搜索工具", spec: "2千次",
			  now: 60, orig: 100, limit: 3, valid: 3 },
			{ id: "zp-education-glmocr", zone: "education",
			  name: "GLM-OCR", spec: "5000万tokens",
			  now: 8, orig: 10, limit: 3, valid: 3 },
			{ id: "zp-education-glmimage", zone: "education",
			  name: "GLM-Image", spec: "500次",
			  now: 35, orig: 50, limit: 3, valid: 3 },
			{ id: "zp-education-cogvideox3", zone: "education",
			  name: "CogVideoX-3", spec: "200次",
			  now: 120, orig: 200, limit: 3, valid: 3 },
		];

		/** 专区顺序（沿用官方页面结构，不按折率排 —— 各专区门槛不同，混排会误导） */
		const PACK_ZONES = [
			{ id: "flash_sale", label: "尝鲜秒杀" },
			{ id: "developer", label: "开发者" },
			{ id: "enterprise", label: "企业" },
			{ id: "education", label: "教育" },
		];

		/** 资源包折率 = 现价 / 原价。与 discText 分开：那个处理预存的乘数，这里是从两个价格算出来的。 */
		function packRate(p) {
			if (!p || !p.orig || p.orig <= 0 || !p.now) return null;
			return p.now / p.orig;
		}
		...
		const AFFILIATE_FALLBACK = {
			...
			items: [
				...
				{ id: "baidu-ambassador-product", name: "百度智能云 · 大使邀新特惠专场",
				  url: "https://cloud.baidu.com/campaign/ambassador-product/index.html?ambassadorId=804d5d4644dc44349eba35669ee94bf6", inviteCode: null, badge: "新客低至1折",
				  benefit: "百度智能云「大使邀新特惠专场」：热销千帆大模型、AI 原生应用、云服务器等多款产品低至 1 折；另有 20 元大模型新用户代金券（限官网/控制台购买千帆产品）。仅限新用户或产品新用户（不含代理商伙伴及代理商客户）；活动价不可与其他优惠叠加，不支持降配、退款。",
				  rewardType: "cps", providerIds: ["baidu-qianfan"], routerProviderIds: [] },
		...
		/** 限时活动一行 */
		/** 资源包卡片。折率由 packRate() 从两个价格现算，不用预存值 —— 官方调价后自动跟随。 */
		function ResourcePackCard(props) {
			const p = props.p;
			const t = props.t;
			const rate = packRate(p);
			return h("div", { className: "mc_pack" },
				h("div", { className: "mc_pack-top" },
					h("span", { className: "mc_pack-name", title: p.name }, p.name),
					h("span", { className: "mc_pack-spec" }, p.spec)
				),
				h("div", { className: "mc_pack-price" },
					h("span", { className: "mc_pack-now" }, "¥" + p.now),
					h("span", { className: "mc_pack-orig" }, "¥" + p.orig),
					rate !== null ? h("span", { className: "mc_pack-off" }, t("pack.off", { d: String(Math.round(rate * 1000) / 100) })) : null
				),
				h("div", { className: "mc_pack-meta" },
					t("pack.limit", { n: p.limit }) + " · " + t("pack.valid", { n: p.valid }))
			);
		}
		...
		function ModelClockView() {
			...
			/* ---- 资源包特惠（独立口径，不进热力带） ---- */
			const packSection = h("section", { className: "mc_sec" },
				h("h3", { className: "mc_sec-title" }, "⑥ " + t("pack")),
				h("p", { className: "mc_sec-hint" }, t("pack.hint")),
				h("div", { className: "mc_panel" },
					RESOURCE_PACKS.length
						? h("div", null,
							PACK_ZONES.map(function (z) {
								const items = RESOURCE_PACKS.filter(function (x) { return x.zone === z.id; });
								if (!items.length) return null;
								return h("div", { key: z.id, className: "mc_pack-zone" },
									h("div", { className: "mc_pack-zone-title" }, z.label),
									h("div", { className: "mc_packs" }, items.map(function (p) {
										return h(ResourcePackCard, { key: p.id, p: p, t: t });
									}))
								);
							}),
							h("div", { className: "mc_pack-note" }, t("pack.note"))
						)
						: h("div", { className: "mc_empty" }, t("pack.none"))
				)
			);
			/* ---- 溯源 ---- */
			...
			return h(react.Fragment, null,
				...
				h("div", { className: "mc_root" },
					head, bestSection, bandSection, advSection, affSection, campSection, packSection, metaSection
				)
			);
		}
